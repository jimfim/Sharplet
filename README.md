...
[![Docker Pulls](https://img.shields.io/docker/pulls/jimfim/sharplet)](https://hub.docker.com/r/jimfim/sharplet)
[![Quality gate status](https://sonarcloud.io/api/project_badges/measure?project=jimfim_Sharplet&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=jimfim_Sharplet)
