...
// functions because, for a top-level program, local functions count toward the
// top-level file's own cognitive complexity: S3776 kept firing no matter how the
// top-level statements were split.
